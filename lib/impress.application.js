...
impress.mixinApplication = function(application) {
  ...
  // Load place file
  //   placeName:string - place name (subdirectory name in application base directory)
  //   placeDir:string - directory path
  ...
  // Start task
  //   taskName:string - task name in application.tasks hash
  //
  ...
  //   match:Array - URL elements mached route.urlRx
  //   req - request is an instance of http.IncomingMessage
  //   res - rsponse is an instance of http.ServerResponse
  ...
  // Add static to cache
  //   relPath:string - file path relative to application base directory
  //   stats - instance of fs.Stats
