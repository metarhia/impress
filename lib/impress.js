...
//
impress.serverConfigDefinition = require('./config.impress.definition');
impress.applicationConfigDefinition = require('./config.application.definition');
