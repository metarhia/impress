...
impress.test({
  ...
  'api.definition.validate': [
    [ { a: 5, b: 'b', c: [1,2,3] },      { schema: { a: 'number', b: 'string', c: 'array' } },     'schema', { valid: true,  errors: [] } ],
    [ { a: '5', b: 'b', c: [1,2,3] },    { schema: { a: 'number', b: 'string', c: 'array' } },     'schema', { valid: false, errors: [ { path: '.a', error: 'Unexpected value "5" for definition: number' } ] } ],
    [ { a: { b: { c: { d: 'e' } } } },   { ab: '{b}', b: '{c}', c: '{d}', d: { d: 'string' } },    'ab',     { valid: true,  errors: [] } ],
    [ { a: { b: { c: { d: 'e' } } } },   { ab: '{b}', b: '{c}', c: '{d}', d: { d: 'string' } },    'abc',    { valid: false, errors: [ { path: '.a', error: 'Unexpected name "a"' } ] } ],
    [ { a: { b: { c: { d: 123 } } } },   { ab: '{b}', b: '{c}', c: '{d}', d: { d: 'number' } },    'ab',     { valid: true,  errors: [] } ],
    [ { a: { bb: { c: { d: 123 } } } },  { ab: '{b}', b: '{c}', c: '{d}', d: { d: 'number' } },    'ab',     { valid: true,  errors: [] } ], // verify
    [ { name1: 'val1', name2: 'val2' },  { name1: '(val1|val2|val3)', name2: '(val1|val2|val3)' }, 'name1',  { valid: true,  errors: [] } ],
    [ { items: [ { a: 1 }, { a: 2 } ] }, { schema: { items: '{{item}}' }, item: { a: 'number' } }, 'schema', { valid: true,  errors: [] } ],
  ]
});
