  ...
  impress.scale.init = function() {
    if (api.cluster.isMaster && impress.config.scale) {
      ...
      if (cc.instance === 'controller') {
        ...
        impress.scale.pub.bind(cc.controller+':'+cc.subPort, function(err) {
        ...
        impress.scale.rep.bind(cc.controller+':'+cc.reqPort+'', function(err) {
          if (err) console.log(err);
        ...
        impress.scale.sub.connect(cc.controller+':'+cc.subPort);
        ...
        impress.scale.req.connect(cc.controller+':'+cc.reqPort);
