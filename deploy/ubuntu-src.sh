...
cd /usr/src
sudo wget http://nodejs.org/dist/v5.10.0/node-v5.10.0.tar.gz
sudo tar zxf node-v5.10.0.tar.gz
sudo rm -f ./node-v5.10.0.tar.gz
cd node-v5.10.0
sudo ./configure
sudo make
sudo make install
cd ~
sudo rm -rf /usr/src/node-v5.10.0
