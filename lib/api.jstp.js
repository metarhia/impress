...
//   data - JSTP array of objects serialized into arrays
...
api.jstp.buildPrototype = function(metadata) {
  ...
  for (var name in metadata) {
    ...
    buildGetter = api.jstp.getters[fieldType];
...
api.jstp.getters.string = function(proto, name, index) {
...
api.jstp.getters.Date = function(proto, name, index) {
  Object.defineProperty(proto.prototype, name, {
    get: function() {
...
api.jstp.getters.function = function(proto, name, index, fieldDef) {
