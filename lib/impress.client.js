...
Client.prototype.checkRestrictions = function() {
  ...
  var sec = Math.round(Date.now() / 1000); // new Date().getTime() / 1000;
  //console.log('Client.prototype.checkRestrictions --- '+sec);
  //console.dir(application.limit.ips);
