...
impress.subst = function(tpl, data, dataPath, escapeHtml) {
  //console.dir({tpl:tpl, dataPath:dataPath, data:data});
  tpl = tpl.replace(/@([\-\.0-9a-zA-Z]+)@/g, function(s, key) {
    ...
    //console.dir({dataPath:dataPath,value:value,type:typeof(value)});
...
//
impress.dataByPath = function(data, dataPath, strict) {
  strict = strict || false;
  //console.dir({dataPath:dataPath, data:api.stringify(data)});
