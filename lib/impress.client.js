...
Client.prototype.restoreSession = function(
  ...
  if (application) {
    ...
    if (sid) {
      const session = application.sessions[sid];
...
Client.prototype.fileHandler = function(
  ...
  const fileCache = application.cache.files[relPath];
...
Client.prototype.detectRealPath = function(
  ...
  const folderCache = application.cache.folders[relPath];
...
Client.prototype.staticCache = function(
  ...
  const cache = application.cache.static[relPath];
