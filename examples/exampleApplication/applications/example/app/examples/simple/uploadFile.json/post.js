    ...
    for (var fieldName in client.files) {
      ...
      for (var i in field) {
        var file = field[i],
            ...
            folder1 = api.impress.generateKey(2, '0123456789'),
            folder2 = api.impress.generateKey(2, '0123456789'),
            code = api.impress.generateKey(8, 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'),
