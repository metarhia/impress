...
impress.sse.mixinApplication = function (application) {
	...
	application.Client.prototype.sseConnect = function() {
		...
		if (client.session && client.logged) {
			var uid = client.application.sessions[client.session].userId
		...
		if (client.eventChannel && !client.res.headersSent) {
			...
			if (!application.events.channels[client.eventChannel]) application.events.channels[client.eventChannel] = [];
			var channelUsers = application.events.channels[client.eventChannel];
