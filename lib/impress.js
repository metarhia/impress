(function(impress) {
	...
	impress.mixinContextScript = impress.vm.createScript('impress.initContext(global)', 'mixinContextScript.vm');
	...
	function mixinApplication(application) {
		...
		application.createSandbox = function() {
			...
			impress.mixinContextScript.runInNewContext(this.sandbox);
		}
