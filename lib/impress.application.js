...
impress.mixinApplication = function(application) {
        ...
        if (cfg) {
          ...
          if (pre) {
            ...
            if (data) stats.size = data.length;
              ...
              application.cache.static[application.relative(filePath)] = impress.FILE_PARSE_ERROR;
  ...
  application.watchCache = function(relPath) {
    //console.log('watchCache '+relPath);
    var filePath = application.relative(relPath),
