...
class Application extends events.EventEmitter {
  constructor() {
    ...
    const staticPath = path.join(this.path, 'static');
    const resourcesPath = path.join(this.path, 'resources');

    this.api = {};
    this.signatures = {};
    this.static = new Resources(staticPath);
    this.resources = new Resources(resourcesPath);
