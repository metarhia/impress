...
impress.cloud.call = function(app, name, data, callback) {
  if (impress.cloud.status === 'online') {
    ...
    var packet = impress.cloud.socket.packet('call', app, name, data);
...
// Send event
//
impress.cloud.event = function(app, name, data, id, target, to) {
  if (impress.cloud.status === 'online') {
    //console.log('impress.cloud.event in '+impress.nodeId);
    var packet = impress.cloud.socket.packet('event', app, name, data, id, target, to);
