...
api.v8.optimizationStatus = function(code) { return api.v8.OPT_STATUS[code]; };

/*setInterval(function() {
  console.log('api.v8.getOptimizationStatus: ' + api.v8.optimizationStatus(api.v8.getOptimizationStatus(impress.applications['example'].Client)));
  console.log('api.v8.getOptimizationCount: ' + api.v8.getOptimizationCount(impress.applications['example'].Client));
  console.log('api.v8.hasFastProperties: ' + api.v8.hasFastProperties(impress.applications['example'].Client));
}, 5000);
*/