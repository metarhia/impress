    ...
    if (file.endsWith('.js')) {
      application.createScript(configFile, function(err, exports) {
        ...
        if (configDefinition[sectionName]) {
          validationResult = api.definition.validate(exports, configDefinition, sectionName);
          if (!validationResult.valid) {
            console.log('Errors in configuration found. Application: '+application.name.yellow.bold+' Config file: '+sectionName.yellow.bold);
            var j, error;
