...
class Client {
  ...
  constructor(application, req, res) {
    ...
    this.parameters = req.parameters || {}; // <Object>
  ...
  processing() {
    ...
    const handlers = ['access', this.method];
  ...
  // File handler
  //   handler <string> handler file name: access, request
  //     and HTTP methods: get, post, put, delete, patch, head
  ...
  render(data, tpl, cursor, callback) {
    ...
    api.metasync.series(doc, iterate, () => {
