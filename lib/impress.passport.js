...
impress.passport.mixin = (application) => {
  ...
  for (providerName in providers) {
    ...
    strategies[providerName] = {
      authenticate: api.passport.authenticate(
        providerId,
        { scope: provider.scope || '' }
      ),
      authenticateCallback: api.passport.authenticate(
        providerId,
        {
  ...
  impress.Client.prototype.passportInit = function(
