...
impress.health.getServerState = (
  ...
  const cpu = impress.health.cpuTimes();
...
function cmdExec(
  // Executing and parsing command line for impress.health.getDrives
  cmd, // command string
