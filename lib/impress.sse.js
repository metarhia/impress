...
var SSE_CONNECTED = api.common.buffer(':' + new Array(2049).join(' ') + '\n\n'),
    SSE_SET_RETRY = api.common.buffer('retry: 2000\n\n'),
    SSE_HEARTBEAT = api.common.buffer(':\n\n'),
...
impress.sse.mixin = function(application) {
  ...
  application.sse.heartbeat = api.timers.setInterval(function() {
