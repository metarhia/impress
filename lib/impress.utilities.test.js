...
impress.test({
  ...
  'impress.dataByPath': [
    [ { item: { subitem: { value: 'Gagarin' } } }, 'item.subitem.value', false, 'Gagarin' ],
    [ { item: { subitem: { value: 123       } } }, 'item.subitem.value', false,  123 ],
    [ { item: { subitem: { value: true      } } }, 'item.subitem.value', false,  true ],
    [ { item: { subitem: { value: false     } } }, 'item.subitem.value', false,  false ],
    [ { item: { subitem: { value: 'Gagarin' } } }, 'item.subitem.none',  false,  function(result) { return JSON.stringify(result) === '{"value":"Gagarin"}' } ],
    [ { item: { subitem: { value: 'Gagarin' } } }, 'item.subitem.none',  true,   undefined ],
    [ { item: { subitem: { value: null      } } }, 'item.subitem.value', false,  function(result) { return JSON.stringify(result) === '{"value":null}' } ],
    [ { item: { subitem: { value: null      } } }, 'item.subitem.value', true,   null ],
    [ { item: { subitem: { value: 'Gagarin' } } }, 'item.none.value',    true,   undefined ],
    [ { item: { subitem: { value: 'Gagarin' } } }, 'item.subitem',       true,   function(result) { return JSON.stringify(result) === '{"value":"Gagarin"}' } ],
    [ { item: { subitem: { value: 'Gagarin' } } }, 'item.subitem',       false,  function(result) { return JSON.stringify(result) === '{"value":"Gagarin"}' } ],
  ],
  'impress.htmlEscape': [
    [ 'text', 'text' ],
    [ '<tag>', '&lt;tag&gt;' ],
