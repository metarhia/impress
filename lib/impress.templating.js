...
//   data:hash - object or hash with data to be rendered using given template
//   file:string - file name to read template in native Impress format
...
// Include template
//   data:hash - object or hash with data to be rendered using given template
//   filePath:string - file path relative to application directory to read template in native Impress format
//   cursor:string - dot-separated path in data object/hash
//   callback(string) - callback with one parameter containing rendered string
//
...
//   data:hash - object or hash with data to be rendered using given template
//   tpl:string - template in native Impress format
//   cursor:string - dot-separated path in data object/hash
