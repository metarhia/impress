...
const { common } = require('./dependencies.js');
...
module.exports = () => {
  ...
  class Session {
    constructor(token, sandbox, contextData = {}) {
  ...
  const start = (client, userId) => {
    const { characters, secret, length } = application.config.sections.sessions;
  ...
  return Object.freeze({
    fillPool, start, restore, remove, save, registerUser, getUser
  });
};
