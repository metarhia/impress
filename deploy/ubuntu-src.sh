...
cd /usr/src
sudo wget http://nodejs.org/dist/v5.10.1/node-v5.10.1.tar.gz
sudo tar zxf node-v5.10.1.tar.gz
sudo rm -f ./node-v5.10.1.tar.gz
cd node-v5.10.1
sudo ./configure
sudo make
sudo make install
cd ~
sudo rm -rf /usr/src/node-v5.10.1
