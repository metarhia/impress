...
//require('./impress.cloud.tcp');
//require('./impress.cloud.ipc');
//require('./impress.cloud.zmq');
...
impress.balancer = function(socket /* res */) {
  ...
  var count = impress.config.scale.workers,
      id = (Math.abs(ip) % impress.config.scale.workers) + 1,
